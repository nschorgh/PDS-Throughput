...
ls  200908010*.TAB | wc
ls  200908010*.gz | wc
ls  200908010*.TAB-lev9.lz4 | wc
ls  200908010*.lzma | wc
ls  200908010*.zip | wc
ls  200908010*.TAB-lev19.zst | wc
...
# lz4-9
/usr/bin/time -o tmp -a  csh -c 'ls 200908010*.TAB-lev9.lz4 | parallel -X -I% --max-args 1  -j 6  filter1_lz4.cmd'
...
# zstd-19
/usr/bin/time -o tmp -a  csh -c 'ls 200908010*.TAB-lev19.zst | parallel -X -I% --max-args 1  -j 6   filter1_zstd.cmd'
